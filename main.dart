...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 179, 255, 64)),
        useMaterial3: true,
      ...
      home: const MyHomePage(title: 'Action buttons : Increment & Toggle'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final summerImg = 'assets/img1.jpeg', winterImg = 'assets/img2.jpeg' ;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: const Color.fromARGB(255, 204, 172, 177), // Set background color
      body: Center(
        child: Column(
